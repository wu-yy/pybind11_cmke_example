...
#define LOGV(v) \
    _LOG_IF(i, FLAGS_log_vprefix.size() ? \
        leetcode::check_vlog(__FILELINE__, v) : \
        (v) <= FLAGS_log_v, v)
...
#define LOGg LOGv >> leetcode::green
#define LOGr LOGv >> leetcode::red
#define LOGy LOGv >> leetcode::yellow
#define LOGgg LOGvv >> leetcode::green
#define LOGrr LOGvv >> leetcode::red
#define LOGyy LOGvv >> leetcode::yellow
#define LOGggg LOGvvv >> leetcode::green
#define LOGrrr LOGvvv >> leetcode::red
#define LOGyyy LOGvvv >> leetcode::yellow
#define LOGgggg LOGvvvv >> leetcode::green
#define LOGrrrr LOGvvvv >> leetcode::red
#define LOGyyyy LOGvvvv >> leetcode::yellow
